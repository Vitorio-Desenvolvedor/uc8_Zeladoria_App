...
export default function FormSala() {
  ...
  // Função de carregamento das salas
  const buscarSalas = async () => {
    try {
      ...
      // Extrai blocos únicos para filtro horizontal
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Lista vertical de salas com pull-to-refresh */}
      <FlatList
        data={salasFiltradas}
      ...
      {/* Área administrativa visível apenas para staff */}
      {user?.is_staff && (
